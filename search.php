...
<center>
<h1>
  Rezultati pretrage "<?php echo $_GET["keyword"]; ?>"
</h1>
    <?php
        ...
        $sql = "SELECT * FROM naslovi WHERE naslov LIKE ? ORDER BY id DESC";
        $keyword = '%' . $_GET["keyword"] . '%';
        $res = mysqli_execute_query($conn, $sql, [$keyword]);
        if(mysqli_num_rows($res)==0){
            echo "<br><br><h1>Nema rezultata</h1>";
            die();
        }
